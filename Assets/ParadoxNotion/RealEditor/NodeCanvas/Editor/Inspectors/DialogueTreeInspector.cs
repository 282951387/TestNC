...
namespace NodeCanvas.Editor
{
    ...
    public class DialogueTreeInspector : GraphInspector
    {
        ...
        public static void ShowActorParameters(DialogueTree dialogue)
        {
            ...
            {
                DialogueTree.ActorParameter reference = dialogue.actorParameters[i];
                GUILayout.BeginHorizontal();
                if (dialogue.actorParameters.Where(r => r != reference).Select(r => r.name).Contains(reference.name))
                {
                    GUI.backgroundColor = Color.red;
                }
                string newRefName = EditorGUILayout.DelayedTextField(reference.name);
                ...
                Object newReference = EditorGUILayout.ObjectField(reference.actor as Object, typeof(Object), true);
