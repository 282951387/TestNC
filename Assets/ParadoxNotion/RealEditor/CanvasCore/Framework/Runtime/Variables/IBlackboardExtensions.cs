...
namespace NodeCanvas.Framework
{
    ...
    public static class IBlackboardExtensions
    {
        ...
        public static IEnumerable<IBlackboard> GetAllParents(this IBlackboard blackboard, bool includeSelf)
        {
            ...
            IBlackboard current = blackboard.parent;
            while (current != null)
            {
        ...
        public static Variable AddVariable(this IBlackboard blackboard, string varName, object value)
        {
            ...
            Variable newVariable = blackboard.AddVariable(varName, value.GetType());
            if (newVariable != null)
            {
        ...
        public static Variable AddVariable(this IBlackboard blackboard, string varName, Type type)
        {
            ...
            Type variableType = typeof(Variable<>).RTMakeGenericType(new Type[] { type });
            Variable newVariable = (Variable)Activator.CreateInstance(variableType);
        ...
        public static T GetVariableValue<T>(this IBlackboard blackboard, string varName)
        {
            ...
            Variable<T> variable = GetVariable<T>(blackboard, varName);
            if (variable == null)
            {
        ...
        public static void InitializePropertiesBinding(this IBlackboard blackboard, Component target, bool callSetter)
        {
            ...
            foreach (Variable data in blackboard.variables.Values)
            {
        ...
        public static Variable GetVariable(this IBlackboard blackboard, string varName, Type ofType = null)
        {
            ...
            {
                Variable result = blackboard.parent.GetVariable(varName, ofType);
        ...
        public static Variable GetVariableByID(this IBlackboard blackboard, string ID)
        {
            ...
            if (blackboard.parent != null)
            {
                Variable result = blackboard.parent.GetVariableByID(ID);
                if (result != null) { return result; }
            }
        ...
        public static IEnumerable<Variable> GetVariables(this IBlackboard blackboard, Type ofType = null)
        {
            ...
            if (blackboard.parent != null)
            {
                foreach (Variable subVariable in blackboard.parent.GetVariables(ofType))
                {
        ...
        {
            Type variableType = typeof(Variable<>).RTMakeGenericType(new Type[] { newType });
            Variable newVariable = (Variable)Activator.CreateInstance(variableType, new object[] { target.name, target.ID });
        ...
        {
            foreach (KeyValuePair<string, Variable> pair in sourceBlackboard.variables)
            {
            ...
            {
                List<string> keys = new List<string>(blackboard.variables.Keys);
