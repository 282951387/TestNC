...
namespace NodeCanvas.Editor
{
    ...
    public static partial class Prefs
    {
        ...
        {
            string pref = EditorPrefs.GetString(PREFS_KEY_NAME);
        ...
        public static readonly UnityEngine.Vector2 MINIMAP_MIN_SIZE = new UnityEngine.Vector2(50, 30);
        public static readonly UnityEngine.Vector2 MINIMAP_MAX_SIZE = new UnityEngine.Vector2(500, 300);
        ...
        public static UnityEngine.Vector2 minimapSize
        {
            get
            {
                UnityEngine.Vector2 result = data.minimapSize;
