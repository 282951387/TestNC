    ...
    public class fsReflectedConverter : fsConverter
    {
        ...
        public override fsResult TrySerialize(object instance, out fsData serialized, Type storageType)
        {
            ...
            for (int i = 0; i < metaType.Properties.Length; ++i)
            {
                ...
                object propertyValue = property.Read(instance);
                ...
                fsResult itemResult = Serializer.TrySerialize(property.StorageType, propertyValue, out serializedData);
        ...
        public override fsResult TryDeserialize(fsData data, ref object instance, Type storageType)
        {
            ...
            for (int i = 0; i < metaType.Properties.Length; ++i)
            {
                ...
                if (data.AsDictionary.TryGetValue(property.JsonName, out propertyData))
                {
                    ...
                    fsResult itemResult = Serializer.TryDeserialize(propertyData, property.StorageType, ref deserializedValue, null);
                    result.AddMessages(itemResult);
                    if (itemResult.Failed)
                    {
                        continue;
